...
//Original Source https://github.com/Reactive-Extensions/Rx.NET/blob/master/Rx.NET/Source/System.Reactive.Core/Reactive/Disposables/CompositeDisposable.cs
using System;
    ...
    public sealed class CompositeDisposable : ICollection<IDisposable>
    {
        ...
        public CompositeDisposable(IEnumerable<IDisposable> disposables)
        {
            ...
            if (_disposables.Contains(null))
                throw new ArgumentException("Disposables cannot contain null!", "disposables");
